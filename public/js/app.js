...
/* harmony import */ var _ocrv_vue_tailwind_pagination_styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ocrv/vue-tailwind-pagination/styles */ "./node_modules/@ocrv/vue-tailwind-pagination/dist/style.css");
...
(0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_2__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    ...
    }).use(plugin) // .use(DropZone)
    // .use(require('axios'))
    .use(ziggy__WEBPACK_IMPORTED_MODULE_4__.ZiggyVue, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy).use(vue_axios__WEBPACK_IMPORTED_MODULE_9__["default"], (axios__WEBPACK_IMPORTED_MODULE_8___default())).component('file-upload', (__webpack_require__(/*! @yazan.alnughnugh/file-upload */ "./node_modules/@yazan.alnughnugh/file-upload/Index.vue")["default"])).component("Link", _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_2__.Link).component("Head", _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_2__.Head).mixin({
      methods: {
        route: route
      }
    }).mount(el);
...
var map = {
	...
	"./AboutUs": [
		...
		"/js/vendor",
		"resources_js_Pages_AboutUs_vue"
	],
	"./AboutUs.vue": [
		"./resources/js/Pages/AboutUs.vue",
		"/js/vendor",
	...
	"./Admin/Dashboard": [
		...
		"/js/vendor",
		"node_modules_moment_locale_sync_recursive_-resources_js_Pages_Admin_Dashboard_vue"
	],
	"./Admin/Dashboard.vue": [
		"./resources/js/Pages/Admin/Dashboard.vue",
		"/js/vendor",
	...
	"./Admin/SearchUsersPage": [
		"./resources/js/Pages/Admin/SearchUsersPage.vue",
		"/js/vendor",
		"resources_js_Pages_Admin_SearchUsersPage_vue"
	],
	"./Admin/SearchUsersPage.vue": [
		"./resources/js/Pages/Admin/SearchUsersPage.vue",
		"/js/vendor",
		"resources_js_Pages_Admin_SearchUsersPage_vue"
	],
	...
	"./Profile/ChangePassword": [
		...
		"/js/vendor",
		"resources_js_Pages_Profile_ChangePassword_vue"
	],
	...
	"./Profile/EditPost": [
		...
		"/js/vendor",
		"resources_js_Pages_Profile_EditPost_vue"
	],
	"./Profile/EditPost.vue": [
		"./resources/js/Pages/Profile/EditPost.vue",
		"/js/vendor",
		"resources_js_Pages_Profile_EditPost_vue"
	],
	"./Profile/EditProfile": [
		...
		"/js/vendor",
		"resources_js_Pages_Profile_EditProfile_vue"
	],
	...
	"./Profile/MakePost": [
		...
		"/js/vendor",
		"resources_js_Pages_Profile_MakePost_vue"
	],
	"./Profile/MakePost.vue": [
		"./resources/js/Pages/Profile/MakePost.vue",
		"/js/vendor",
		"resources_js_Pages_Profile_MakePost_vue"
	],
	"./Profile/PostPage": [
		...
		"/js/vendor",
		"resources_js_Pages_Profile_PostPage_vue"
	],
	"./Profile/PostPage.vue": [
		"./resources/js/Pages/Profile/PostPage.vue",
		"/js/vendor",
		"resources_js_Pages_Profile_PostPage_vue"
	],
